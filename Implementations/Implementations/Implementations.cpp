...
public:
    ...
    {-2315.638496	,4903.262393,	4148.511478},
    };
};
...
public:
    ...
    {-3960.124379	,5566.506875, - 190.1330947},
...
private:
    ...
    {3.119540174 ,- 3.602805512,	5.983113295},
...
private:
    ...
    {-0.663548828, - 0.735899878, - 7.575820029},
...
int main()
{
    ...
    TestFunctionV1 v1;
    TestFunctionV2 v2;
    double gamma = 2839.67183480081, tmax = 2839.67183480081;
